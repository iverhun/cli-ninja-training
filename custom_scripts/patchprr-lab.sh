...
mysql --socket=/var/lib/mysql-multi/$1/mysqld.$1.sock -u root $2 < $3

rc=$?

if [ rc == O ]
then
  mysql --socket=/var/lib/mysql-multi/$1/mysqld.$1.sock -u root -e "INSERT INTO $2.Patches (Name, CreateTimestamp) VALUES ('$3', NOW())"
